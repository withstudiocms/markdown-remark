				...
				addVirtualImports(params, {
					...
					imports: {
						...
						'studiocms:markdown-remark': `
							export { render, Markdown, Props, RenderResponse } from '${resolve('./virtual-components.js')}';
						`,
			...
			'astro:config:done'({ injectTypes, config }) {
				...
				injectTypes({
					...
					declare module 'studiocms:markdown-remark' {
						export const render: typeof import('${resolve('./virtual-components.js')}').render;
						export const Markdown: typeof import('${resolve('./virtual-components.js')}').Markdown;
						export type Props = import('${resolve('./virtual-components.js')}').Props;
						export type RenderResponse = import('${resolve('./virtual-components.js')}').RenderResponse;
					}
